...
namespace code.Models
{
    ...
    public class TrainNote:Note{
        ...
        public TrainNote(int tid,int uid,SQLService ns){
            s = ns;
    ...
    public class WagonNote:Note{
        ...
        public WagonNote(int vid,int uid,SQLService ns){
            s = ns;
            IEnumerable<NpgsqlParameter> parameters = new List<NpgsqlParameter>();
            parameters.Append(new NpgsqlParameter("user_id",uid));
    ...
    public class BlackBoard{
        ...
        SQLService s;
        public BlackBoard(SQLService ns){
            s = ns;
            IEnumerable<NpgsqlParameter> parameters = new List<NpgsqlParameter>();
    ...
    public class Wagon{
        ...
        int NOrder{get;set;}
        SQLService s;
        public Wagon(int vid,int tid,SQLService ns){
            s = ns;
            IEnumerable<NpgsqlParameter> parameters = new List<NpgsqlParameter>();
    ...
    public class TrainTemplate{
        ...
        public TrainTemplate(int nid,SQLService ns){
            s = ns;
            IEnumerable<NpgsqlParameter> parameters = new List<NpgsqlParameter>();
            parameters.Append(new NpgsqlParameter("id",nid));
    ...
    public class Train{
        ...
        public Train(int nid,SQLService ns){
            s = ns;
            IEnumerable<NpgsqlParameter> parameters = new List<NpgsqlParameter>();
            parameters.Append(new NpgsqlParameter("id",nid));
            NpgsqlDataReader reader = s.sqlCommand("SELECT * FROM wagons WHERE id = ($1)", parameters);
            ...
            while(reader.Read()){
                var a = new Wagon((int)reader[0],Id,s);
                Wagons.Add(a);
            }
